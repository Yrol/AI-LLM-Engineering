...
from .views import open_ai_web_summarizer, open_ai_ask_anything,open_ai_ticketing_assistant,open_ai_create_brochure, open_ai_assistant, ollama_chat, ollama_create_brochure, ollama_web_summarizer
